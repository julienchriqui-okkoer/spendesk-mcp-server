...
export const TOOL_CATEGORY: Record<string, UsageCategory> = {
  ...
  spendesk_get_purchase_order: "purchase_orders",
  spendesk_create_purchase_order: "purchase_orders",
  spendesk_cancel_purchase_order: "purchase_orders",
  spendesk_close_purchase_order: "purchase_orders",
