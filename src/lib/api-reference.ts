...
export const API_REFERENCE = {
  ...
  endpoints: [
    ...
    },
    {
      ...
      bodyParams: [
        { name: "from", type: "string", required: false, description: "Start date ISO" },
        { name: "to", type: "string", required: false, description: "End date ISO" },
      ],
    },
    {
      method: "GET",
    ...
    // —— Purchase Orders ————————————————————————————————————————————————————
    {
      ...
      queryParams: [
        ...
        { name: "supplierId", type: "string", required: false, apiKey: "supplier_id", description: "Filter by supplier" },
        { name: "userId", type: "string", required: false, apiKey: "user_id", description: "Filter by user" },
        { name: "from", type: "string", required: false, apiKey: "created_from", description: "Created from date ISO" },
        { name: "to", type: "string", required: false, apiKey: "created_to", description: "Created to date ISO" },
        { name: "createdFrom", type: "string", required: false, apiKey: "created_from", description: "Created from date ISO" },
        { name: "createdTo", type: "string", required: false, apiKey: "created_to", description: "Created to date ISO" },
        { name: "updatedFrom", type: "string", required: false, apiKey: "updated_from", description: "Updated from" },
        { name: "updatedTo", type: "string", required: false, apiKey: "updated_to", description: "Updated to" },
